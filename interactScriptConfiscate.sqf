_intelConfiscate = _this select 0;
[
    _intelConfiscate,                                                                           // Object the action is attached to
    "Confiscate / Confiscar",                                                                       // Title of the action
    ...
    {["taskIntelConfiscate", "SUCCEEDED", true] call BIS_fnc_taskSetState; deleteVehicle intelConfiscated; [(_this select 0),(_this select 2)] remoteExec ["BIS_fnc_holdActionRemove", 0];},  // Code executed on completion
...
] remoteExec ["BIS_fnc_holdActionAdd", 0, _intelConfiscate];                                 // example for MP compatible implementation
