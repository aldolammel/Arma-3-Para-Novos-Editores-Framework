_hackingBurn = _this select 0;
[
    _hackingBurn,                                                                           // Object the action is attached to
    "Hacking / Hackear",                                                                       // Title of the action
    ...
    {["tskHacking", "SUCCEEDED", true] call BIS_fnc_taskSetState; [(_this select 0),(_this select 2)] remoteExec ["BIS_fnc_holdActionRemove", 0];},    // Code executed on completion
...
] remoteExec ["BIS_fnc_holdActionAdd", 0, _hackingBurn];                                 // example for MP compatible implementation
